        ...
        <div class="header-middle bg-white py-4">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <a wire:navigate href="{{ route('home') }}" class="header-logo h1">I-Shop</a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="offcanvas offcanvas-start" id="offcanvasNavbar" tabindex="-1"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a wire:navigate class="nav-link active" aria-current="page" href="{{ route('home') }}">Домашняя</a>
                            </li>
